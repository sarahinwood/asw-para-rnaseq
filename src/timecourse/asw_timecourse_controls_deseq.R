...
##Make table of results for asw_timecourse_controls vs control heads
...
fwrite(ordered_res_group_table, "output/asw_timecourse_controls/deseq2/res_group.csv")
ordered_sig_res_group_table <- subset(ordered_res_group_table, padj < 0.05)
fwrite(ordered_sig_res_group_table, "output/asw_timecourse_controls/deseq2/asw_timecourse_controls_analysis_sig_degs.csv", col.names = TRUE, row.names = FALSE)
##Sub in any gene of interest to plot counts  
plotCounts(dds_group, "ASW_TRINITY_DN47701_c0_g1", intgroup = c("group"), main="")
##volcano plot
...
fwrite(sig_w_annots, "output/asw_timecourse_controls/deseq2/wout_8hNC1_sig_genes_with_annots.csv")


only_8h1 <- fread("output/asw_timecourse_controls/deseq2/8hNC1_only_asw_timecourse_controls_analysis_sig_degs.csv")
only_8h1_degs <- only_8h1$rn

wout_8h1 <- fread("output/asw_timecourse_controls/deseq2/wout_8hNC1_asw_timecourse_controls_analysis_sig_degs.csv")
