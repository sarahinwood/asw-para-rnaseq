...
res_timecourse <- fread("output/asw_mh_timecourse/deseq2/timecourse_all_genes.csv")
...
fwrite(sig_trans_leading_annots, "output/asw_timecourse/fgsea/signal_transduction/sig_trans_leading_edge_annots.csv")
...
fwrite(trans_leading_annots, "output/asw_timecourse/fgsea/transcription_regulation/trans_reg_leading_edge_annots.csv")
##plot enrichment of GO term
...
fwrite(tf_activity_leading_annots, "output/asw_timecourse/fgsea/tf_activity/tf_activity_leading_edge_annots.csv")
...
fwrite(DNA_integration_leading_annots, "output/asw_timecourse/fgsea/DNA_integration/DNA_integration_leading_edge_annots.csv")
